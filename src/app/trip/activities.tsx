...
export function Activities({ tripDetails }: Props) {
  ...
  async function handleCreateTripActivity() {
    try {
      if (!activityTitle || !activityDate || !activityHour) {
        return Alert.alert("Cadastar atividade", "Preencha todos os campos!");
      }
  ...
  async function getTripActivities() {
    try {
      ...
      const activitiesToSectionsList = activities.map((dayActivity) => ({
        title: {
      ...
      setTripActivities(activitiesToSectionsList);
    } catch (error) {
      console.log(error);
    } finally {
